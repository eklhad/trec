/*********************************************************************
Pack the 35 hexominoes into a rhombus minus a ssquare in the middle.
*********************************************************************/
...
static int squareFlip(void)
{
if(board[1][8] > board[29][8]) return 1;
if(board[15][1] > board[15][15]) return 1;
return 0;
}
...
++nsols;
if(!countflag && nsols % 1000 == 0) showBoard();
}
} else {
int h2 = h1;
...
if(argc > 1) {
fprintf(stderr, "usage: sqxsol [-c|-d]\n");
exit(1);
}
