...
uchar zero_spin, zero_dxy, zero_dxz, zero_dyz, zero_hr, zero_vr, zero_zr;
...
for(j=0; j<o_max; ++j) {
o = o_list + j;
if(dim_x != dim_y || dim_z < o->rng_z) o->zero_dxy = 0;
if(dim_x != dim_z || dim_y < o->rng_y) o->zero_dxz = 0;
if(dim_y != dim_z || dim_x < o->rng_x) o->zero_dyz = 0;
if(dim_x != dim_y || dim_x != dim_z || dim_x < o->rng_x) o->zero_spin = 0;
...
printf("warning: equivalent solutions will be generated by diagonal reflection when piece %d is at the origin: ", o->pno);
print_o(o);
}
if(o->zero_spin) {
printf("warning: equivalent solutions will be generated by spin when piece %d is at the origin: ", o->pno);
print_o(o);
}
if(o->zero_hr) {
printf("warning: equivalent solutions will be generated by horizontal reflection when piece %d is at the origin: ", o->pno);
print_o(o);
}
if(o->zero_vr) {
printf("warning: equivalent solutions will be generated by vertical reflection when piece %d is at the origin: ", o->pno);
print_o(o);
}
if(o->zero_zr) {
printf("warning: equivalent solutions will be generated by z reflection when piece %d is at the origin: ", o->pno);
print_o(o);
}
}
}
